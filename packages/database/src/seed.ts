...
export function bladesHairSeed(): ClientConfig {
  ...
  return {
    ...
    unknownTopics: ["weekend opening", "add-on treatments and extras prices", "named stylist live availability", "exact layered-cut final price"],
    calendar: {
      provider: "calcom",
      username: calUser,
      credentialRef: "CALCOM_API_KEY",
...
Phones: 020 7623 1994 or 020 7929 6680.
Timetable: Monday to Friday 10:00am–7:00pm (speak it as weekdays ten till seven). Do not assume weekend opening.
...
Layered cuts and restyles: priced at consultation — book a short visit first; never invent a fixed layered-cut price.
Hair up and colour correction: priced at consultation.
