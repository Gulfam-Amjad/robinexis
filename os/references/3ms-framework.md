...
- **Never impersonates you.** Signs off as "Joe Sturdy's AI assistant."
...
The 3Ms is the foundation. Specific topics go deeper in dedicated frameworks. Most aren't built into this kit yet. They'll grow into `references/` over time:
...
> *Full breakdown with diagrams and examples: [insert link to companion video / public-facing page when published].*
